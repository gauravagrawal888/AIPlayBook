...
namespace Common
{
    public class Configuration
    {
        ...
        /// Container name for blob datasource
        /// </summary>
        [ConfigurationKeyName("AZURE_FOUNDRY_PROJECT_ENDPOINT")]
        public string AIFoundryProjectEndPoint { get; set; }

        /// <summary>
        /// Container name for blob datasource
        /// </summary>
        [ConfigurationKeyName("AZURE_SEARCH_CONNECTION_ID")]
        public string AISearchConnectionId { get; set; }

        /// <summary>
        /// Container name for blob datasource
        /// </summary>
        [ConfigurationKeyName("BING_SEARCH_CONNECTION_ID")]
        public string BingSearchConnectionId { get; set; }
